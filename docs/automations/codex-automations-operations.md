...
> 状态：Active　版本：**1.13**　日期：**2026-09-26**　变更历史见 §9
...
> **依据 = 章程 §11.2（G8 两层互斥锁）/ §11.3（运行日与轮次产物）/ §11.4（阶段报告）；本子块由 ADR-0049 追加。**
...
3. 写 docs/automations/<运行日日期>-round-<N>.md（N = 现有 round-* 文件数 + 1），记：本轮做了什么、依据哪些文件、验收结果、遗留；
