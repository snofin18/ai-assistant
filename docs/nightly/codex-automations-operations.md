...
> 状态：Active　版本：**1.2**　日期：**2026-09-25**　变更历史见 §9
...
> 机制**已可用**；**已排期（2026-09-25）** —— 人类 2026-09-25 授权后已创建正式 automation `ai-assistant-nightly-task-chain`（cron / 每日 02:30 / local；见 §9 v1.2）。
