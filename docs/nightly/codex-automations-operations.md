...
> 状态：Active　版本：**1.3**　日期：**2026-09-25**　变更历史见 §9
...
> 机制**已可用**；**已排期（2026-09-25）** —— 人类 2026-09-25 授权后已创建正式 automation（cron / local）：`ai-assistant-nightly-task-chain`（每日 **02:30**）与 `ai-assistant-nightly-task-chain-2330`（每日 **23:30**）；见 §9 v1.2 / v1.3。
